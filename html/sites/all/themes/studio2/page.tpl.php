...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language->language ?>" >
  <head>
    ...
    <?php print $styles ?>
    <?php print $scripts ?>
    <!--[if lte IE 7]><?php print studio2_get_ie_styles(); ?><![endif]--> <!--If Less Than or Equal (lte) to IE 7-->
  </head>
  <body<?php print studio2_body_class($left, $right); ?>>
    <?php if ($topnav): ?>
      <div id="topnav"><?php print $topnav ?></div>
    <?php endif; ?>
    <!-- Layout -->
    <div class="container"> <!-- add "showgrid" class to display grid -->
      ...
      <div id="main">
        ...
        <?php if ($title): print '<h2 id="title"'. ($tabs ? ' class="with-tabs"' : '') .'>'. $title .'</h2>'; endif; ?>
